...
# 指定输出导出文件夹路径
export_path="/Users/super/Desktop/自动化生成的包/Package/$scheme_name-$DATE"
# 指定输出归档文件路径
...
export_options_plist_path="/Users/super/Desktop/自动化生成的包/ExportOptions.plist"
